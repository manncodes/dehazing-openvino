        ...
        **kwargs
        ...
        self.sigma_mapping = (
            ...
            if sigma_mapping is not None
                ...
                nn.BatchNorm2d(
                    num_features=self.out_channels // self.reduce_ratio, momentum=0.3
                ),
                nn.ReLU(),
            )
        )
...
class InvoFFA(nn.Module):
    def __init__(self, gps, blocks, conv=default_conv):
        super(InvoFFA, self).__init__()
        self.gps = gps
        self.dim = 64
        kernel_size = 3
...
if __name__ == "__main__":
    net = InvoFFA(gps=3, blocks=19)
    print(net)
    # save net
    torch.save(net.state_dict(), "InvoFFA_3_19_init.pth")
